...
public class BowlingBallBlock extends Block {
	public BowlingBallBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(PlannittwoModBlocks.BOWLING_BALL.get(), renderType -> renderType == RenderType.cutout());
	}
}
