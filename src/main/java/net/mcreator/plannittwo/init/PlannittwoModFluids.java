...
import net.mcreator.plannittwo.fluid.PeeFluid;
import net.mcreator.plannittwo.PlannittwoMod;

public class PlannittwoModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, PlannittwoMod.MODID);
